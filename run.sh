# --------------------------------------------------------------------------- 
# Filename: /home/ubuntu/wip/educative-apigateway-44-comprehend/run.sh         #
# Path: /home/ubuntu/wip/educative-apigateway-44-comprehend                    #
# Created Date: Monday, October 10th 2022, 12:55:51 pm                         #
...
# -----------------------------------------------------------------
curl --location --request POST $url --header 'Content-Type: application/json' --data-raw '{"LanguageCode": "en", "Text": "Hello Tom, Jerry is waiting for you."}'
